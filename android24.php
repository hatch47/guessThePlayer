...
echo '<p style="display: inline; font-size: 18px; margin: 0;"><b>2023-24</b></p><br>';
echo '</div>';
...
$query = "SELECT player FROM playerinfo24 WHERE gp > 15 ORDER BY PLAYER";
