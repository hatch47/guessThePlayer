...
echo '<td><button style="width: 150px; height: 50px; background-color: PaleTurquoise;" onclick="subtract5Points(); toggleVisibility(\'gp\')">Games Played</button></td>';
...
echo '<tr>';
echo '<td><button style="width: 150px; height: 50px; background-color: PaleTurquoise;" onclick="subtract10Points(); toggleVisibility(\'penaltiesdrawn\')">Penalties Drawn</button></td>';
echo '<td><div id="penaltiesdrawn" style="display: none;"><b>' . $selectedPlayer['penaltiesdrawn'] . '</b></div></td>';
echo '<td><button style="width: 150px; height: 50px; background-color: PaleTurquoise;" onclick="subtract5Points(); toggleVisibility(\'dateofbirth\')">Date of Birth</button></td>';
echo '<td><div id="dateofbirth" style="display: none;"><b>' . $selectedPlayer['dateofbirth'] . '</b></div></td>';
echo '</tr>';

// button for Draft Round Draft Position
echo '<tr>';
echo '<td><button style="width: 150px; height: 50px; background-color: PaleTurquoise;" onclick="subtract10Points(); toggleVisibility(\'draftround\')">Draft Round</button></td>';
